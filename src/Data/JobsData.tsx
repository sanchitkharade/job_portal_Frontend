...
const dropdownData = [
    { title: "Job Title", icon: IconSearch, options: ['Student','Designer', 'Developer', 'Product Manager', 'Marketing Specialist', 'Data Analyst', 'Sales Executive', 'Content Writer', 'Customer Support'] },
    { title: "Location", icon: IconMapPin, options: ['Pune','Delhi','Mumbai','Banglore','Kolkata','Hydrabad','Chennai', 'New York', 'San Francisco', 'London', 'Berlin', 'Tokyo', 'Sydney', 'Toronto'] },
