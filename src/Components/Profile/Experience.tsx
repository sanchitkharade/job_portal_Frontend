...
const Experience = () => {
  ...
  <div className="text-2xl font-semibold mb-5 flex justify-between">Experience <div className="flex gap-2"> <ActionIcon onClick={()=>setaddExp(true)} size="lg" variant="subtle" color="brightSun.4" ><IconPlus className="h-4/5 w-4/5"/>
  </ActionIcon>
