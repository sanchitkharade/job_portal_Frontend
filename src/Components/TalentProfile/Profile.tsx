...
const Profile = (props:any)=>{
    return <div className="w-2/3">
        <div className="relative">
            ...
            <img className=" w-48 h-48 rounded-full absolute -bottom-1/3 left-3 border-8 border-mine-shaft-950" src="/avatar.png" alt="" />
            </div>
          ...
          <IconMapPin className="h-5 w-5" stroke={1.5} />{props.location}</div>
            </div>
            <Divider mx="xs" my="xl"/>
            <div className="px-3">
