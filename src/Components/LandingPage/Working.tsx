    ...
    <div className="mt-20 pb-5">
      ...
      <div className="flex px-16 bs-mx:px-10 gap-2 md-mx:flex-col md-mx:px-5 justify-between items-center">
        <div className="relative"> 
            ...
            <div className="w-36 xs-mx:w-28 flex top-[15%] -right-5 absolute flex-col items-center gap-1 border border-bright-sun-400 rounded-xl py-3 px-1 backdrop-blur-md">
                <Avatar className="!h-16 !w-16 xs-mx:!h-12 xs-mx:!w-12" src="avatar1.png" alt=""/>
