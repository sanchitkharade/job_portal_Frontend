...
const JobCategory=()=>{
    return <div className="mt-20 pb-5">
        ...
        <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2">Explore diverse Job opportunities tailered to your skills. Start your Career journey today !</div>
        <Carousel slideSize="22%"  slideGap="md" loop>
            ...
            <div className="text-blue-300 text-lg">{category.jobs}+ New Job Posted</div>
            </div>
                </Carousel.Slide>)
            }
    </Carousel>
