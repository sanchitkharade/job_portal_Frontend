...
const Testimonials=()=>{
    return <div className="mt-20 pb-5 p-5">
        ...
        <div className="flex gap-5 justify-evenly md-mx:flex-wrap mt-10">
        {
            testimonials.map((data,index)=><div key={index} className="flex flex-col gap-3 w-[23%] md-mx:w-[48%] xs-mx:w-full border border-bright-sun-400 p-3 rounded-xl ">
            <div className="flex gap-2 items-center">
                <Avatar className="!h-14 !w-14" src="avatar.png" alt="Av"/>
                <div>
